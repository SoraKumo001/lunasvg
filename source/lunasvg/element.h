#ifndef LUNASVG_ELEMENT_H
#define LUNASVG_ELEMENT_H
...
public:
    ...
    virtual bool isFilterPrimitiveElement() const { return false; }
...
public:
    ...
    SVGFilterElement* getFilter(const std::string_view& id) const;
